"""
    ...
    File to implement the main loop of the game
"""
...
class TicTacToe:
    ...
    #validate players have unique/opposite marks
    def __post_init__(self):
        validate_players(self.player1, self.player2)

    #main loop, blank grid and "X" starting break on game_over GameState
